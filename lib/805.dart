...
class HomePageState extends State<HomePage> {
  ...
  Widget rowSwitchWeight() =>
      Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text('Bold ', textScaleFactor: 1.5),
            Switch(
                value: _switchWeight,
  ...
  Widget rowSwitchStyle() =>
      Row(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text('Italic ', textScaleFactor: 1.5),
            Switch(
                value: _switchStyle,
                onChanged: (isOn) => setState(() {
                  _switchStyle = isOn;
                  _fontStyle = isOn ? FontStyle.italic :
                  FontStyle.normal;
                }
                )
            ),
